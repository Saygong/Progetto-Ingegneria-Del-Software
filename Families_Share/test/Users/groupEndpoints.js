...
describe('/Post/api/users/id/groups', () => {
  it('it should add an authenticated user as member of a group given the correct parameters', (done) => {
...
describe('/Post/api/users/id/groups', () => {
  it('it should not add a user as member of a group given incorrect parameters', (done) => {
    User.findOne({ email: 'test3@email.com' }, (err, user) => {
      Group.findOne({ name: 'Test Group Edit' }, (error, group) => {
        const member = {
          admin: true
...
describe('/Post/api/users/id/groups', () => {
  it('it should not add a user as member of a group when user is not authenticated ', (done) => {
