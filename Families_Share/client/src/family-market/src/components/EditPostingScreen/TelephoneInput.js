...
<<<<<<< HEAD:Families_Share/client/family-market/src/components/EditPostingScreen/TelephoneInput.js
                <img src={phoneIconPath} alt={txt.altImageText} className="col-2-10"/>
=======
                <img src= "" alt={txt.altImageText} className="col-2-10"/>
>>>>>>> testing:Families_Share/client/src/family-market/src/components/EditPostingScreen/TelephoneInput.js
