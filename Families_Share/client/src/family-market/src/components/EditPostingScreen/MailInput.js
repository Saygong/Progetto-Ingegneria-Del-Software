    ...
    render() {
        ...
        return (
            <div className="row no-gutters">
                {/*TODO add mail image*/}
<<<<<<< HEAD:Families_Share/client/family-market/src/components/EditPostingScreen/MailInput.js
                <img src={mailIconPath} alt={txt.altImageText} className="col-2-10"/>
=======
                <img src="" alt={txt.altImageText} className="col-2-10"/>
>>>>>>> testing:Families_Share/client/src/family-market/src/components/EditPostingScreen/MailInput.js
